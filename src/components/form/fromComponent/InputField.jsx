  ...
  return (
    <div className="mb-6">
      ...
      <input
        id={id}
        type={type}
        className={`w-full px-4 py-2.5 border rounded-lg shadow-sm text-textPrimary placeholder-textMuted transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 ${
          error 
